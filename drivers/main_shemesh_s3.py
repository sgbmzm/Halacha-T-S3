...
while True:
    ...
    if power_state:
        ...
        voltage = read_battery_voltage()
        # אם המתח מעל 5 וולט והמשתמש רוצה בהירות מקס כפי שהוגדר בתחילת הקוד אז הבהירות הכי גבוהה
        ...
        duty_for_backligth = PWM_MAX if (voltage >= 5.0 and behirut_max) else 450 if voltage > 4.6 else 255
