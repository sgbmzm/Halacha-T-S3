...
def toggle_power(pin):
    ...
    global location
    # המשתנה ששולט על השאלה איזה מיקום יהיה המיקום הבא שיופיע בדפדוף כשמדפדפים ברשימת המיקומים
    global location_index
    # המשתנה הגלובלי ששולט על הזמן שממנו סופרים מספר שניות או דקות עד שהמסך ייכבה מעצמו
    global start_time_for_automatic_deepsleep
...
def main_main():
    ...
    # או שהולכים לשינה עמוקה או שהולכים לכיבוי רגיל שכולל בתוכה שינה רגילה לכמה ימים עד שיעירו את המכשיר באמצעות לחיצה על כפתור ההפעלה 
        ...
        # אם לא מוגדר שינה עמוקה הולכים לכיבוי מסך ולשינה רגילה    
            ...
            RD.value(0)
            LCD_POWER.value(0)
            # שולחים את המכשיר לשינה רגילה של 11.5 ימים !!!!!! אבל אם רוצים להעיר אז הלחיצה על כפתור ההפעלה גורמת לקוד להתחיל שוב מקובץ מיין הראשי וזה כאילו ריסט
            time.sleep(999999) #  זה גורם לחסכון ממשי בצריכת החשמל כשלא הולכים לשינה עמוקה אלא רק לכיבוי מסך
