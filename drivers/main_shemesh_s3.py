...
# זה זמני רק כדי למחוק את הקובץ main_bme280_s3 מתוך בקרים שנמצא בהם הקובץ הזה מפני שהוא כבר לא בשימוש
...
esberim = [
        ...
        ["לחצן תחתון משמש רק להדלקה וכיבוי", ""],
        ["לחצן עליון משמש לביצוע פעולות", ""],
        ["לחיצה קצרה משנה מיקום", ""],
        ["  לחיצה מתמשכת מגדירה מיקום קבוע", ""],
        ["התחלה כשהלחצן לחוץ מעדכנת שעון", ""],
        [" הדלקה בשני הלחצנים מעדכנת תוכנה", ""],
...
def main_main():
    ...
    seconsd_to_start_auto_deepsleep = 121 
