...
esberim = [
        ...
        ["צפון=0, מז=09, דר=081, מע=072", ""], # המספרים כתובים בכוונה הפוך כי אחר כך מיישרים אותם ברוורס יחד עם העברית
...
while True:
    ...
    if power_state:
        ...
        main()
        current_screen = (current_screen + 0.3) % len(esberim)  # זה גורם מחזור של שניות לאיזה נתונים יוצגו במסך
